...
export const fr = {
  ...
  ABOUT_DESCRIPTION: 'Nous sommes une plateforme leader dans la location de voitures, engagée à vous offrir la meilleure expérience de mobilité. Avec une large flotte de véhicules et un service d\'excellence, nous facilitons vos déplacements de manière sûre, confortable et fiable.',
  FEATURES_TITLE: 'Caractéristiques Principales',
  FEATURE_FLEET_TITLE: 'Large Flotte de Véhicules',
  FEATURE_FLEET_DESC: 'Des modèles économiques aux premiums, trouvez la voiture parfaite pour vous',
  FEATURE_EASY_TITLE: 'Réservation Facile et Rapide',
  FEATURE_EASY_DESC: 'Louez votre véhicule en quelques minutes depuis votre smartphone',
  FEATURE_SECURE_TITLE: 'Sûr et Fiable',
  FEATURE_SECURE_DESC: 'Tous nos véhicules sont entièrement assurés',
  FEATURE_PAYMENT_TITLE: 'Paiements Sécurisés',
  FEATURE_PAYMENT_DESC: 'Multiples méthodes de paiement avec technologie cryptée',
  LEGAL_TITLE: 'Informations Légales',
  PRIVACY_POLICY: 'Politique de Confidentialité',
  OPEN_SOURCE_LICENSES: 'Licences Open Source',
  FOLLOW_US: 'Suivez-nous',
  FOOTER_COPYRIGHT: '© 2026 Rent a Car',
  FOOTER_MADE_WITH: 'Fait avec ❤️ au Pérou',
  TOS_TITLE: "Conditions d'Utilisation",
  TOS_DATE: 'Dernière mise à jour : Février 2026',
  TOS_SECTION_1_TITLE: '1. Acceptation des Conditions',
  TOS_SECTION_1_CONTENT: 'En accédant et en utilisant cette application, vous acceptez d\'être lié par ces Conditions d\'Utilisation et toutes les lois et réglementations applicables. Si vous n\'acceptez pas l\'un de ces termes, il vous est interdit d\'utiliser ou d\'accéder à ce service.',
  TOS_SECTION_2_TITLE: '2. Utilisation du Service',
  TOS_SECTION_2_CONTENT: 'Vous acceptez d\'utiliser le service uniquement à des fins légales et d\'une manière qui n\'enfreint pas les droits de tiers, ni ne restreint ou n\'empêche l\'utilisation et la jouissance du service par quiconque.',
  TOS_SECTION_3_TITLE: '3. Confidentialité et Données Personnelles',
  TOS_SECTION_3_CONTENT: 'Votre confidentialité est importante pour nous. Nous collectons, utilisons et protégeons vos informations personnelles conformément à notre Politique de Confidentialité. En utilisant ce service, vous consentez à la collecte et à l\'utilisation de vos informations tel que décrit.',
  TOS_SECTION_4_TITLE: '4. Propriété Intellectuelle',
  TOS_SECTION_4_CONTENT: 'Tout le contenu inclus dans cette application, tel que texte, graphiques, logos, images et logiciels, est la propriété de l\'entreprise ou de ses fournisseurs de contenu et est protégé par les lois sur le droit d\'auteur.',
  TOS_SECTION_5_TITLE: '5. Limitation de Responsabilité',
  TOS_SECTION_5_CONTENT: 'En aucun cas, l\'entreprise ne sera responsable des dommages indirects, accessoires, spéciaux ou consécutifs découlant de l\'utilisation ou de l\'incapacité d\'utiliser le service.',
  TOS_SECTION_6_TITLE: '6. Modifications',
  TOS_SECTION_6_CONTENT: 'Nous nous réservons le droit de modifier ces conditions à tout moment. Les modifications entreront en vigueur immédiatement après leur publication sur l\'application.',
  TOS_SECTION_7_TITLE: '7. Contact',
  TOS_SECTION_7_CONTENT: 'Si vous avez des questions concernant ces Conditions d\'Utilisation, vous pouvez nous contacter via les canaux de support fournis dans l\'application.',
  CONTACT_TITLE: 'Contactez-nous',
  CONTACT_SUBTITLE: 'Nous sommes là pour vous aider. Choisissez votre canal préféré pour communiquer avec nous.',
  CONTACT_EMAIL: 'E-mail',
  CONTACT_PHONE: 'Téléphone',
  CONTACT_WEBSITE: 'Site Web',
  CONTACT_SCHEDULE_TITLE: 'Heures d\'ouverture',
  CONTACT_SCHEDULE_WEEKDAYS: 'Lundi au Vendredi : 9h00 - 18h00',
  CONTACT_SCHEDULE_SATURDAY: 'Samedis : 9h00 - 13h00',
  CONTACT_SCHEDULE_SUNDAY: 'Dimanche : Fermé',
  CONTACT_LOCATION_TITLE: 'Emplacement',
  CONTACT_LOCATION_CITY: 'Lima, Pérou',
  CONTACT_LOCATION_ADDRESS: 'Av. Principal 123, Miraflores',
}

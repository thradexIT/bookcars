...
export const es = {
  ...
  ABOUT_DESCRIPTION: 'Somos una plataforma líder en alquiler de vehículos, comprometidos con brindarte la mejor experiencia de movilidad. Con una amplia flota de vehículos y un servicio de excelencia, facilitamos tus desplazamientos de manera segura, cómoda y confiable.',
  FEATURES_TITLE: 'Características Principales',
  FEATURE_FLEET_TITLE: 'Amplia Flota de Vehículos',
  FEATURE_FLEET_DESC: 'Desde económicos hasta premium, encuentra el auto perfecto para ti',
  FEATURE_EASY_TITLE: 'Reserva Fácil y Rápida',
  FEATURE_EASY_DESC: 'Alquila tu vehículo en minutos desde tu smartphone',
  FEATURE_SECURE_TITLE: 'Seguro y Confiable',
  FEATURE_SECURE_DESC: 'Todos nuestros vehículos cuentan con seguro completo',
  FEATURE_PAYMENT_TITLE: 'Pagos Seguros',
  FEATURE_PAYMENT_DESC: 'Múltiples métodos de pago con tecnología encriptada',
  LEGAL_TITLE: 'Información Legal',
  PRIVACY_POLICY: 'Política de Privacidad',
  OPEN_SOURCE_LICENSES: 'Licencias de Código Abierto',
  FOLLOW_US: 'Síguenos',
  FOOTER_COPYRIGHT: '© 2026 Rent a Car',
  FOOTER_MADE_WITH: 'Hecho con ❤️ en Perú',
  TOS_TITLE: 'Términos de Servicio',
  TOS_DATE: 'Última actualización: Febrero 2026',
  TOS_SECTION_1_TITLE: '1. Aceptación de los Términos',
  TOS_SECTION_1_CONTENT: 'Al acceder y utilizar esta aplicación, usted acepta estar sujeto a estos Términos de Servicio y a todas las leyes y regulaciones aplicables. Si no está de acuerdo con alguno de estos términos, se le prohíbe usar o acceder a este servicio.',
  TOS_SECTION_2_TITLE: '2. Uso del Servicio',
  TOS_SECTION_2_CONTENT: 'Usted se compromete a utilizar el servicio únicamente para fines legales y de manera que no infrinja los derechos de terceros ni restrinja o inhiba el uso y disfrute del servicio por parte de terceros.',
  TOS_SECTION_3_TITLE: '3. Privacidad y Datos Personales',
  TOS_SECTION_3_CONTENT: 'Su privacidad es importante para nosotros. Recopilamos, usamos y protegemos su información personal de acuerdo con nuestra Política de Privacidad. Al utilizar este servicio, usted consiente la recopilación y el uso de su información según lo descrito.',
  TOS_SECTION_4_TITLE: '4. Propiedad Intelectual',
  TOS_SECTION_4_CONTENT: 'Todo el contenido incluido en esta aplicación, como texto, gráficos, logos, imágenes y software, es propiedad de la empresa o sus proveedores de contenido y está protegido por las leyes de derechos de autor.',
  TOS_SECTION_5_TITLE: '5. Limitación de Responsabilidad',
  TOS_SECTION_5_CONTENT: 'En ningún caso la empresa será responsable por daños indirectos, incidentales, especiales o consecuentes que resulten del uso o la imposibilidad de usar el servicio.',
  TOS_SECTION_6_TITLE: '6. Modificaciones',
  TOS_SECTION_6_CONTENT: 'Nos reservamos el derecho de modificar estos términos en cualquier momento. Las modificaciones entrarán en vigor inmediatamente después de su publicación en la aplicación.',
  TOS_SECTION_7_TITLE: '7. Contacto',
  TOS_SECTION_7_CONTENT: 'Si tiene preguntas sobre estos Términos de Servicio, puede contactarnos a través de los canales de soporte proporcionados en la aplicación.',
  CONTACT_TITLE: 'Contáctanos',
  CONTACT_SUBTITLE: 'Estamos aquí para ayudarte. Elige el canal que prefieras para comunicarte con nosotros.',
  CONTACT_EMAIL: 'Correo Electrónico',
  CONTACT_PHONE: 'Teléfono',
  CONTACT_WEBSITE: 'Sitio Web',
  CONTACT_SCHEDULE_TITLE: 'Horario de Atención',
  CONTACT_SCHEDULE_WEEKDAYS: 'Lunes a Viernes: 9:00 AM - 6:00 PM',
  CONTACT_SCHEDULE_SATURDAY: 'Sábados: 9:00 AM - 1:00 PM',
  CONTACT_SCHEDULE_SUNDAY: 'Domingos: Cerrado',
  CONTACT_LOCATION_TITLE: 'Ubicación',
  CONTACT_LOCATION_CITY: 'Lima, Perú',

...
export const fr = {
  ...
  RESERVATION_RECEIVED_SUBJECT: 'Nous avons reçu votre réservation',
  RESERVATION_RECEIVED_BODY: "Nous avons reçu votre demande de réservation. Si vous avez choisi le paiement en ligne, la réservation reste en attente jusqu'à la confirmation du fournisseur de paiement.",
  PAYMENT_APPROVED_SUBJECT: 'Paiement approuvé',
  PAYMENT_APPROVED_BODY: 'Votre paiement a été approuvé par Mercado Pago.',
  RESERVATION_CONFIRMED_SUBJECT: 'Réservation confirmée',
  RESERVATION_CONFIRMED_BODY: 'Votre réservation est confirmée.',
  CANCELLATION_REQUESTED_SUBJECT: "Demande d'annulation reçue",
  CANCELLATION_REQUESTED_BODY: "Nous avons reçu votre demande d'annulation. La réservation n'est pas considérée comme annulée tant que le changement de statut n'est pas confirmé.",
  RESERVATION_CANCELLED_SUBJECT: 'Réservation annulée',
  RESERVATION_CANCELLED_BODY: 'Votre réservation a été annulée.',
  ...
  BOOKING_CONFIRMED_PART2: 'a été confirmée.',

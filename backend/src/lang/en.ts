...
export const en = {
  ...
  RESERVATION_RECEIVED_SUBJECT: 'We received your reservation',
  RESERVATION_RECEIVED_BODY: 'We received your reservation request. If you selected online payment, the reservation remains pending until the payment provider confirms the transaction.',
  PAYMENT_APPROVED_SUBJECT: 'Payment approved',
  PAYMENT_APPROVED_BODY: 'Your payment was approved by Mercado Pago.',
  RESERVATION_CONFIRMED_SUBJECT: 'Reservation confirmed',
  RESERVATION_CONFIRMED_BODY: 'Your reservation is confirmed.',
  CANCELLATION_REQUESTED_SUBJECT: 'Cancellation request received',
  CANCELLATION_REQUESTED_BODY: 'We received your cancellation request. The reservation is not considered cancelled until the status change is confirmed.',
  RESERVATION_CANCELLED_SUBJECT: 'Reservation cancelled',
  RESERVATION_CANCELLED_BODY: 'Your reservation has been cancelled.',
  ...
  BOOKING_CONFIRMED_PART2: 'is confirmed.',
  ...
  CAR_ALREADY_BOOKED: 'This car is already booked during the selected dates.',
}

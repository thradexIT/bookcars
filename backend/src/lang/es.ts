...
export const es = {
  ...
  RESERVATION_RECEIVED_SUBJECT: 'Hemos recibido su reserva',
  RESERVATION_RECEIVED_BODY: 'Hemos recibido su solicitud de reserva. Si eligió pago en línea, la reserva permanecerá pendiente hasta que el proveedor de pagos confirme la operación.',
  PAYMENT_APPROVED_SUBJECT: 'Pago aprobado',
  PAYMENT_APPROVED_BODY: 'Su pago fue aprobado por Mercado Pago.',
  RESERVATION_CONFIRMED_SUBJECT: 'Reserva confirmada',
  RESERVATION_CONFIRMED_BODY: 'Su reserva está confirmada.',
  CANCELLATION_REQUESTED_SUBJECT: 'Solicitud de cancelación recibida',
  CANCELLATION_REQUESTED_BODY: 'Hemos recibido su solicitud de cancelación. La reserva todavía no se considera cancelada hasta que el cambio de estado sea confirmado.',
  RESERVATION_CANCELLED_SUBJECT: 'Reserva cancelada',
  RESERVATION_CANCELLED_BODY: 'Su reserva ha sido cancelada.',
  ...
  BOOKING_CONFIRMED_PART2: 'ha sido confirmada.',

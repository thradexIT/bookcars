const routes = {
  ...
  requestPasswordReset: '/api/request-password-reset/:type',
  validatePasswordReset: '/api/validate-password-reset/:type/:userId/:email/:token',
  resetPassword: '/api/reset-password/:type',
  signup: '/api/sign-up',

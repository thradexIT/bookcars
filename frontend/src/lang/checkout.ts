...
const strings = new LocalizedStrings({
  fr: {
    ...
    PAY_DEPOSIT_INFO: 'Payez le montant le plus élevé entre S/ 35 et 10 % du total. Le solde restant est dû lors du retrait.',
  ...
  en: {
    ...
    PAY_DEPOSIT_INFO: 'Pay whichever is greater: S/ 35 or 10% of the total. The remaining balance is due at pickup.',
  ...
  es: {
    ...
    PAY_DEPOSIT_INFO: 'Paga el mayor entre S/ 35 y el 10% del total. El saldo restante se paga al recoger el vehículo.',

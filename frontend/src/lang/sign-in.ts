...
const strings = new LocalizedStrings({
  fr: {
    ...
    CONNECTION_ERROR: 'Impossible de joindre le service de connexion. Vérifiez la connexion et réessayez.',
  ...
  en: {
    ...
    CONNECTION_ERROR: 'Unable to reach the sign-in service. Check the connection and try again.',
  ...
  es: {
    ...
    CONNECTION_ERROR: 'No se pudo conectar con el servicio de inicio de sesión. Verifique la conexión e inténtelo de nuevo.',
